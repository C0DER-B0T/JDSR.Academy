    ...
    >
      {quickLinks.map((link, index) => (
        <motion.a
          ...
          className={`w-12 h-12 ${link.color} ${link.hoverColor} text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 transform hover:scale-110 hover:shadow-xl will-change-transform gpu-accelerated`}
          whileHover={isAnimationsEnabled ? { scale: 1.1, rotate: 5 } : {}}
